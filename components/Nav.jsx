...
const NavBar = () => {
	...
	return (
		<Fragment>
			<div
				className={`fixed z-10 w-full h-12 flex justify-around items-center bg-black-100 border-b border-gray-700 text-xs ${
				...
				<ul className="w-75 h-8 px-8 flex justify-around items-center border border-gray-700 rounded-[20px] ">
					{navItems.map((item, idx) => (
						<li key={"nav " + idx} className="cursor-pointer">
